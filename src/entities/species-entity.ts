...
export class Species {
  ...
  @Column({ nullable: true, default: null }) public six_l_code: string | null;

  @Column({ nullable: true, default: null }) public species: string | null;

  @Column({ nullable: true, default: null }) public ordo: string | null;

  @Column({ nullable: true, default: null }) public family: string | null;
